---
title: "Econometrics Assignement 4- Brodard Lionel, Giro Tomas, Marchal Antoine, Schonenberger Ivan"
output: 
...
# Exercice 5
# Question a) Using all observations, compute the estimates of the parameters in the estimating equation, estimate the asymptotic covariance matrix, and provide the asymptotic standard errors of the parameter estimates. Program your own estimation procedure and compare the results with an off-the-shelve package/function.
...
# The estimating equation doesnt provide a direct estimate of delta_f . Compute this estimate and provide the asymptotic standard error.
```{r}
